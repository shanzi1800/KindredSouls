...
function useTarot(d1: string, d2: string, lang: string = 'en') {
  ...
  const cards: { name: L; meaning: L }[] = [
    {name:{zh:'愚人',en:'The Fool',es:'El Loco',fr:'Le Fou',th:'คนโง่ประหลาด',vi:'Kẻ Ngốc'}, meaning:{zh:'踏上未知旅程的勇气，新可能的开启',en:'The courage to embark on an unknown journey — new possibilities await.',es:'El valor para emprender un viaje desconocido — nuevas posibilidades le esperan.',fr:'Le courage de partir vers l\'inconnu — de nouvelles possibilités vous attendent.',th:'ความกล้าที่จะเริ่มต้นการเดินทางแห่งความลึกลับ — โอกาสใหม่รอคุณอยู่',vi:'Can đảm bước vào hành trình chưa biết — những khả năng mới đang chờ.'}},
    {name:{zh:'魔术师',en:'The Magician',es:'El Mago',fr:'Le Bateleur',th:'นักมายกล',vi:'Pháp Sư'}, meaning:{zh:'创造显化，意志与行动力的觉醒',en:'Manifestation and creation — willpower awakened into action.',es:'Manifestación y creación — la fuerza de voluntad se despierta en acción.',fr:'Manifestation et création — la volonté s\'éveille en action.',th:'การสร้างสรรค์และการแสดงออก — พลังจิตตื่นขึ้นสู่การลงมือ',vi:'Hiện thực hóa và sáng tạo — ý chí thức tỉnh thành hành động.'}},
    {name:{zh:'女祭司',en:'The High Priestess',es:'La Sacerdotisa',fr:'La Papesse',th:'นางพราหมณี',vi:'Nữ Thần'}, meaning:{zh:'直觉与秘密，等待揭晓的答案',en:'Intuition and mystery — the answer waits to be revealed.',es:'Intuición y misterio — la respuesta espera ser revelada.',fr:'Intuition et mystère — la réponse attend d\'être révélée.',th:'สัญชาตญาณและความลับ — คำตอบรอให้ถูกเปิดเผย',vi:'Trực giác và bí ẩn — câu trả lời đang chờ được bật mí.'}},
    ...
    {name:{zh:'倒吊人',en:'The Hanged Man',es:'El Colgado',fr:'Le Pendu',th:'คนแขวนหัว',vi:'Người Bị Treo'}, meaning:{zh:'放下与臣服，另一种视角的智慧',en:'Surrender and release — wisdom from a different perspective.',es:'Rendición y liberación — sabiduría desde otra perspectiva.',fr:'Lâcher-prise et abandon — sagesse d\'une autre perspective.',th:'การยอมแพ้และการปล่อยวาง — ภูมิปัญญาจากมุมมองอื่น',vi:'Buông bỏ và đầu hàng — sự khôn ngoan từ góc nhìn khác.'}},
    {name:{zh:'死神',en:'Death',es:'La Muerte',fr:'La Mort',th:'เจ้าแห่งความตาย',vi:'Sự Chết'}, meaning:{zh:'结束与蜕变，旧篇章的翻页',en:'Endings and transformation — a new chapter begins.',es:'Finales y transformación — un nuevo capítulo comienza.',fr:'Fins et transformation — un nouveau chapitre commence.',th:'จุดจบและการเปลี่ยนแปลง — บทใหม่เริ่มต้น',vi:'Kết thúc và hoán chuyển — một chương mới bắt đầu.'}},
    {name:{zh:'节制',en:'Temperance',es:'La Templanza',fr:'Tempérance',th:'ความสมดุล',vi:'Sự Ôn Hòa'}, meaning:{zh:'平衡与调和，在两极间找到节奏',en:'Balance and harmony — finding rhythm between opposites.',es:'Equilibrio y armonía — encontrando ritmo entre opuestos.',fr:'Équilibre et harmonie — trouver le rythme entre les contraires.',th:'สมดุลและความสามัคคี — หาจังหวะระหว่างสองขั้ว',vi:'Cân bằng và hài hòa — tìm thấy nhịp điệu giữa hai thái cực.'}},
    ...
    {name:{zh:'审判',en:'Judgement',es:'El Juicio',fr:'Le Jugement',th:'การพิพากษา',vi:'Sự Phán Xử'}, meaning:{zh:'重生与宽恕，灵魂被唤醒',en:'Rebirth and forgiveness — your soul is being called.',es:'Renacimiento y perdón — tu alma está siendo llamada.',fr:'Renaissance et pardon — votre âme est appelée.',th:'การเกิดใหม่และการอภัย — วิญญาณของคุณถูกเรียก',vi:'Tái sinh và tha thứ — tâm hồn bạn đang được gọi.'}},
