...
const HEXAGRAMS: Record<number, HexagramData> = {
  1: {
    ...
    natureVi: "Mạnh mẽ và kiên cường",
    ...
    judgmentVi: "Nguyên hanh lợi chính, kiên trì hưởng phước.",
  ...
  2: {
    ...
    judgmentVi: "Nguyên hanh, lợi về sự thuận theo đức hành.",
  ...
  3: {
    ...
    judgmentVi: "Nguyên hanh lợi chính, chưa thời hành động.",
  ...
  4: {
    ...
    judgmentVi: "Hanh thông, kẻ ngu muội tự tìm đến ta.",
  ...
  5: {
    ...
    natureTh: "รอคอยอดทน",
    natureVi: "Chờ đợi kiên nhẫn",
    natureEs: "Espera",
    natureFr: "Attente",
    judgment: "有孚，光亨贞吉",
    judgmentEn: "Success. Advantageous for litigation.",
    judgmentTh: "สำเร็จ เป็นผลดีในการฟ้องร้อง",
    judgmentVi: "Có phước, quang minh hanh thông, kiên trì cát tường.",
  ...
  6: {
    ...
    natureVi: "Xung đột và tranh cãi",
    ...
    judgmentVi: "Có phước bị ngăn trở, trung gian cát tường.",
  ...
  7: {
    ...
    judgmentVi: "Kiên trì theo đức lớn, cát tường không lỗi.",
  ...
  8: {
    ...
    judgmentVi: "Nguyên thử nguyên vĩnh kiên, không lỗi.",
  ...
  9: {
    ...
    judgmentVi: "Hanh thông, mây đặc chưa hạ mưa.",
  ...
  10: {
    ...
    natureVi: "Thực hành và hành động",
    ...
    judgmentVi: "Đạp đuôi hổ, hổ không cắn, hanh thông.",
  ...
  11: {
    ...
    judgmentVi: "Tiểu tự đại lai, cát tường hanh thông.",
  ...
  12: {
    ...
    judgmentVi: "Bĩ với người phi nhân, bất lợi cho quân tử kiên trì.",
  ...
  13: {
    ...
    judgmentVi: "Đồng nhân tại dã, hanh thông.",
  ...
  15: {
    ...
    natureVi: "Khiêm tốn và nhún nhường",
    ...
    judgmentVi: "Hanh thông, quân tử có thủy chung.",
  ...
  17: {
    ...
    judgmentVi: "Nguyên hanh lợi chính kiên trì, không lỗi.",
  ...
  18: {
    ...
    judgmentVi: "Nguyên hanh, lợi vượt sông lớn.",
  ...
  19: {
    ...
    judgmentVi: "Nguyên hanh lợi chính kiên trì.",
  ...
  20: {
    ...
    judgmentVi: "Hoàn nhiên chí như, hữu phước uy nghi.",
  ...
  21: {
    ...
    judgmentVi: "Hanh thông, lợi cho việc xét xử.",
  ...
  22: {
    ...
    natureVi: "Thanh lịch và duyên dáng",
    ...
    judgmentVi: "Hanh thông, lợi nhỏ có thể tiến.",
  ...
  24: {
    ...
    judgmentVi: "Hanh thông, xuất nhập vô tật.",
  ...
  26: {
    ...
    judgmentVi: "Kiên trì lợi, bất gia thực cát.",
  ...
  27: {
    ...
    natureVi: "Nuôi dưỡng và chăm sóc",
    ...
    judgmentVi: "Kiên trì cát tường, quan dĩ tự cầu khẩu thực.",
  ...
  29: {
    ...
    judgmentVi: "Tập khảm hữu phước duy tâm hanh.",
  ...
  30: {
    ...
    judgmentVi: "Kiên trì hanh thông.",
  ...
  31: {
    ...
    judgmentVi: "Nguyên hanh lợi chính, thất nữ cát.",    relationshipMeaning: '大吉。少男少女心灵感应，第一印象极佳，彼此深深吸引，充满浪漫情调。极其利于恋爱发展，两情相悦。',
  ...
  32: {
    ...
    judgmentVi: "Hanh thông vô lỗi, kiên trì lợi.",
  ...
  33: {
    ...
    natureVi: "Rút lui và lánh tránh",
    ...
    judgmentVi: "Hanh thông, tiểu lợi kiên trì.",
  ...
  35: {
    ...
    judgmentVi: "Hưng hầu chi dụng tích mã phồn thứ.",
  ...
  36: {
    ...
    judgmentVi: "Lợi gian nan kiên trì.",
  ...
  37: {
    ...
    judgmentVi: "Nguyên cát hanh thông.",
  ...
  39: {
    ...
    natureVi: "Khó khăn và khập khiễng",
    ...
    judgmentVi: "Lợi đông nam, bất lợi đông bắc.",
  ...
  41: {
    ...
    judgmentVi: "Hữu phước nguyên cát vô lỗi.",
  ...
  42: {
    ...
    natureVi: "Tăng trưởng và gia tăng",
    ...
    judgmentVi: "Lợi hữu duy tiến, lợi tham sông lớn.",
  ...
  43: {
    ...
    judgmentEn: "Proclaimed in the king's court — crying out, danger.",
    judgmentTh: "ประกาศ ณ ราชสำนัก — ร้องโห่ อันตราย",
    judgmentVi: "Dương vu vương đình, hiệu lệ liễu.",
  ...
  44: {
    ...
    judgmentVi: "Nữ tráng vật dụng thất nữ.",
    ...
    relationshipMeaningVi: 'Hung. Tình cờ gặp gỡ nhưng ẩn tàng nguy cơ, dễ là đào hoa sát. Một bên có thể có ham muốn kiểm soát mạnh mẽ hoặc mục đích khó nói, tình cảm khó duy trì lâu dài nếu thiếu đi sự thấu hiểu chân thành.',
    category: "中",
    scoreRange: [65, 79]
  },
  45: {
  ...
  46: {
    ...
    judgmentEn: "Great success — advantageous to see the great person.",
    judgmentTh: "สำเร็จยิ่งใหญ่ — เป็นผลดีที่จะพบผู้ยิ่งใหญ่",
    judgmentVi: "Nguyên hanh, dụng kiến đại nhân.",
  ...
  47: {
    ...
    natureVi: "Khó khăn và trói buộc",
    ...
    judgmentVi: "Hanh kiên trì, đại nhân cát vô lỗi.",
  ...
  49: {
    ...
    judgmentEn: "On the si day, trust is established — supreme success, advantageous, perseverance.",
    judgmentTh: "วันศรี ความไว้วางใจสถาปนา — สำเร็จยิ่งใหญ่ เป็นผลดี อดทน",
    judgmentVi: "Tị nhật nãi phước, nguyên hanh lợi kiên trì.",
  ...
  52: {
    ...
    judgmentEn: "Keeping his back still, he does not obtain his body.",
    judgmentTh: "นิ่งหลังอยู่ ไม่ได้ตัว",
    judgmentVi: "Cấn kỳ bối, bất hoạt kỳ thân.",
  ...
  53: {
    ...
    judgmentVi: "Tiến triển tuần tự — hôn nhân cát tường, bền vững lâu dài.",
  ...
  54: {
    ...
    natureVi: "Quay về và theo sau",
    natureEs: "Alianza / Séquito",
    natureFr: "Alliance / Soumission",
    judgment: "征凶无攸利",
    judgmentEn: "Advancing — misfortune, nothing advantageous.",
    judgmentTh: "ก้าวไป — อัปมงคล ไม่มีสิ่งใดเป็นผลดี",
    judgmentVi: "Chinh hung vô duy lợi.",
  ...
  56: {
    ...
    judgmentVi: "Tiểu hanh, lữ kiên trì cát.",
  ...
  58: {
    ...
    judgmentVi: "Nguyên hanh kiên trì.",
  ...
  59: {
    ...
    natureVi: "Hòa tan ranh giới",
    natureEs: "Dispersión",
    natureFr: "Dispersion",
    judgment: "王假有庙利涉大川",
    judgmentEn: "The king arrives at the temple — advantageous to cross the great river.",
    judgmentTh: "กษัตริย์เสด็จถึงวัด — ข้ามแม่น้ำใหญ่เป็นผลดี",
    judgmentVi: "Vương giả hữu miếu, lợi tham sông lớn.",
  ...
  60: {
    ...
    judgmentVi: "Hanh, khổ tiết bất khả kiên.",
  ...
  61: {
    ...
    natureVi: "Chân thành và trung tín",
    natureEs: "Sinceridad / Buena fe",
    natureFr: "Sincérité / Bonne foi",
    judgment: "豚鱼吉利涉大川",
    judgmentEn: "Pig and fish — auspicious, advantageous to cross the great river.",
    judgmentTh: "หมูและปลา — เป็นมงคล ข้ามแม่น้ำใหญ่เป็นผลดี",
    judgmentVi: "Đồn ngư ngọc lợi tham sông lớn.",
  ...
  62: {
    ...
    judgmentVi: "Nguyên hanh lợi kiên trì, khả tiểu sự, bất khả đại sự.",
  ...
  63: {
    ...
    judgmentVi: "Hanh tiểu, kiên trì lợi.",
...
export function calcIChing(p1: BirthInfo, p2: BirthInfo, lang: AlgLang = 'zh'): EngineResult {
  ...
  const hexNumLabel: Record<string, string> = {
