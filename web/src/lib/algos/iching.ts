...
const HEXAGRAMS: Record<number, HexagramData> = {
  1: {
    ...
    judgmentVi: "Thành công. Người quân tử đạt kết quả tốt đẹp",
  ...
  2: {
    ...
    judgmentVi: "Thành công lớn. Kiên trì tiến lên. Không lỗi",
  ...
  3: {
    ...
    judgmentVi: "Thành công lớn. Có lợi khi vượt sông lớn",
  ...
  4: {
    ...
    judgmentVi: "Rửa tay nhưng chưa dâng lễ. Thành tâm tận tụy, trang nghiêm",
  ...
  5: {
    ...
    judgmentVi: "Thành công. Có lợi cho kiện tụng",
  ...
  6: {
    ...
    judgmentVi: "Thành công. Được lợi nhỏ khi hành động",
  ...
  7: {
    ...
    judgmentVi: "Kiên trì giữ chính đạo có lợi — Kỷ luật nghiêm minh, mưu sự đại cát",
  ...
  8: {
    ...
    judgmentVi: "Bói toán cát tường. Quan sát hàm răng, tự lo cho mình",
  ...
  9: {
    ...
    judgmentVi: "Cột nhà sụt. Hành động có lợi. Thành công",
  ...
  10: {
    ...
    judgmentVi: "Kiên trì có lợi. Thành công",
  ...
  11: {
    ...
    judgmentVi: "Thành công, thịnh vượng, kiên trì. Gả gái tốt lành",
  ...
  12: {
    ...
    judgmentVi: "Thành công, không lỗi. Kiên trì có lợi",
  ...
  13: {
    ...
    judgmentVi: "Thành công. Hanh thông, có lợi nhỏ",
  ...
  15: {
    ...
    judgmentVi: "Chúa nhân từ ban ngựa, nhân lên gấp bội",
  ...
  18: {
    ...
    judgmentVi: "Hướng tây nam có lợi, đông bắc không lợi",
  ...
  19: {
    ...
    judgmentVi: "Thành tâm. Đại cát, không lỗi",
  ...
  20: {
    ...
    judgmentVi: "Hành động có lợi, vượt sông lớn có lợi",
  ...
  21: {
    ...
    judgmentVi: "Tuyên bố ở triều đình. La hét, nguy hiểm",
  ...
  22: {
    ...
    judgmentVi: "Thuận lợi. Hành động nhỏ cũng mang lại kết quả tốt.",
  ...
  23: {
    ...
    judgmentVi: "Vua đến đền. Thành công",
  ...
  24: {
    ...
    judgmentVi: "Thành công lớn. Có lợi khi gặp người lớn",
  ...
  25: {
    ...
    judgmentVi: "Thành công, kiên định. Người lớn — cát tường, không lỗi",
  ...
  26: {
    ...
    judgmentVi: "Ngày tỵ, dựng lập niềm tin. Thành công lớn, có lợi, kiên trì",
  ...
  27: {
    ...
    judgmentVi: "Thành công. Kính sợ mang lại phước lành",
  ...
  28: {
    ...
    judgmentVi: "Giữ lưng bất động, không được thân",
  ...
  29: {
    ...
    judgmentVi: "Hiểm họa trùng trùng — giữ vững lòng thành, con đường sẽ mở ra.",
  ...
  30: {
    ...
    judgmentVi: "Tiến lên — xui xẻo. Không có gì lợi",
  ...
  31: {
    ...
    judgmentVi: "Thịnh vượng hanh thông — như mặt trời ban trưa, vạn sự xán lạn",    relationshipMeaning: '大吉。少男少女心灵感应，第一印象极佳，彼此深深吸引，充满浪漫情调。极其利于恋爱发展，两情相悦。',
  ...
  32: {
    ...
    judgmentVi: "Thành công nhỏ. Kẻ lữ hành — kiên định, cát tường",
  ...
  33: {
    ...
    judgmentVi: "Thành công nhỏ. Hành động có lợi",
  ...
  34: {
    ...
    judgmentVi: "Thành công, có lợi, kiên định",
  ...
  35: {
    ...
    judgmentVi: "Vua đến đền. Có lợi khi vượt sông lớn",
  ...
  36: {
    ...
    judgmentVi: "Thành công. Hạn chế đắng cay. Không nên kiên trì",
  ...
  37: {
    ...
    judgmentVi: "Gia đạo hòa thuận — cát tường, lợi lộc hanh thông",
  ...
  38: {
    ...
    judgmentVi: "Thành công, có lợi, kiên định. Làm việc nhỏ được, việc lớn không",
  ...
  39: {
    ...
    judgmentVi: "Thành công. Cáo nhỏ gần qua sông, đuôi ướt",
  ...
  40: {
    ...
    judgmentVi: "Có lợi hướng tây nam",
  ...
  41: {
    ...
    judgmentVi: "Thành tâm, thành công lớn, không lỗi",
  ...
  42: {
    ...
    judgmentVi: "Tiến lên có lợi, vượt sông lớn có lợi",
  ...
  44: {
    ...
    judgmentVi: "Duyên gặp gỡ bất ngờ — đề phòng sóng ngầm, cẩn trọng kết duyên",
  ...
  47: {
    ...
    judgmentVi: "Thành công, kiên trì — người lớn, cát tường, không lỗi",
  ...
  48: {
    ...
    judgmentVi: "Đổi làng nhưng giữ giếng. Giá trị cốt lõi không đổi",
  ...
  50: {
    ...
    judgmentVi: "Đại cát tường, thành công",
  ...
  56: {
    ...
    judgmentVi: "Thành công nhỏ — kẻ lữ hành, kiên trì, cát tường",
  ...
  57: {
    ...
    judgmentVi: "Thành công nhỏ, có lợi khi có nơi để đi",
  ...
  58: {
    ...
    judgmentVi: "Thành công, có lợi, kiên trì",
  ...
  60: {
    ...
    judgmentVi: "Thành công — hạn chế đắng cay, kiên trì không lợi",
  ...
  61: {
    ...
    judgmentEn: "Pig and fish — auspicious, advantageous to cross the great river.",
    judgmentTh: "หมูและปลา — เป็นมงคล ข้ามแม่น้ำใหญ่เป็นผลดี",
    judgmentVi: "Thành tâm hiệp đạo — đại cát, vạn sự hanh thông",
  ...
  62: {
    ...
    judgmentVi: "Thành công, có lợi, kiên trì — làm việc nhỏ được, việc lớn không",
  ...
  63: {
    ...
    judgmentVi: "Thành công, nhỏ, kiên trì có lợi",
