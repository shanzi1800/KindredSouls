...
export const SHARED: Record<AlgLang, Record<string, string>> = {
  ...
  es: {
    ...
    iching_trend: 'Tendencia positiva del I Ching',
    ...
    chemistry_cultivate: 'La intimidad física necesita cuidado',
    bazi_pulir: 'Diferencias de personalidad base que superar',
    zodiac_misalign: 'Los estilos de expresión pueden diferir',
    growth_will: 'Ambas comparten voluntad de crecer',
  ...
  fr: {
    ...
    iching_trend: 'Tendance positive du Yi Jing',
    ...
    chemistry_cultivate: "L'intimité physique demande des soins",
    bazi_polish: 'Différences de personnalité de base à combler',
    zodiac_misalign: 'Les styles d\'expression peuvent différer',
    growth_will: 'Les deux partagent la volonté de grandir',
