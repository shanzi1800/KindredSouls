...
function generateAIInsight(
  ...
  // 维度名称（按语言）
  const dimNames: Record<string, { zh: string; en: string; es: string; fr: string }> = {
    love:         { zh: '情感吸引力', en: 'Love & Attraction', es: 'Amor y Atracción', fr: 'Amour et Attraction' },
    communication: { zh: '沟通理解',   en: 'Communication',     es: 'Comunicación',       fr: 'Communication' },
    chemistry:     { zh: '身心默契',   en: 'Chemistry',        es: 'Química',            fr: 'Chimie' },
    stability:     { zh: '长期稳定',   en: 'Long-term Stability', es: 'Estabilidad a Largo Plazo', fr: 'Stabilité à Long Terme' },
  };
